...
function get($query){
  ...
  $hasError = false;
   ...
   if(isset($_POST["submit"]))
   {
	  ...
	  {
	   $query="INSERT INTO delivery_man_add VALUES (NULL, '$name', '$uname', '$pass', '$gender', '$email', '$mobile');";
	   execute($query);
	  }
	  
	  function checkUsername($username){
	  $query = "select * from delivery_man_add where uname='$username'";
	  $result = get($query);
	  if(count($result) > 0){
		  return false;
	  }
...
<div class="imgage">
 <td><img id="myimg" src="images/img_15.jpg" alt="Encryption picture" width="700" height="960"></td>
    </div>
<div class="seller">
